...
the files involved, only `Confidential/AttestationService*.swift` and
`Providers/ProviderStore+Credentials.swift` changed between this commit and
that one, and neither change moved a key.
