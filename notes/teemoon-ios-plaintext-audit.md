...
|---|---|---|---|
| 1.0 (25) | `v1.0.0` → `2d9e206` | QUALIFIED-PASS — one HIGH (no-tap markdown-image auto-fetch) found and fixed pre-publish | [`v1.0.0-2d9e206.md`](/client/teemoon-ios/v1.0.0-2d9e206.md) |
...
| 1.0.2 (33) | `v1.0.2` → `21d534e` | QUALIFIED-PASS — no new plaintext sink in the delta; two blinded reviewers, no finding | [`v1.0.2-21d534e.md`](/client/teemoon-ios/v1.0.2-21d534e.md) |
