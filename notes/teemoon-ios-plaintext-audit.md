...
|---|---|---|---|
| 1.0 (25) | `v1.0.0` → `2d9e206` | QUALIFIED-PASS — one HIGH fixed pre-publish; MEDIUM key-in-URL-cache and LOW system prompt found later, present here | [`v1.0.0-2d9e206.md`](/client/teemoon-ios/v1.0.0-2d9e206.md) |
...
| 1.0.2 (33) | `v1.0.2` → `21d534e` | QUALIFIED-PASS — no new sink in the delta; runtime pass: no unlisted endpoint, but the near.ai key sits in the URL cache on disk (MEDIUM) | [`v1.0.2-21d534e.md`](/client/teemoon-ios/v1.0.2-21d534e.md) |
